...
<body>
	...
	<div class="projeto">
		<div class="explica">
			...
			<div class="textinho">
				<p class="texto-projeto">O foco do nosso projeto é o dimensionamento e detalhamento dos elementos
estruturais (como pilares, vigas, lajes). Com os cálculos evita-se peças
superdimensionadas que possam a vir a ser potencialmente acidentais.</p>
			</div>
		</div>
		<div class="explica2">
