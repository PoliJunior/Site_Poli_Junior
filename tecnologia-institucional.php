	...
	<div class="projeto">
		<div class="explica">
			<div class="nome-projeto">
				<h2>Projeto Site Institucional</h2>
			</div>
			<div class="textinho">
				<p class="texto-projeto">Sistemas mais simples, sites, que possuem o intuito de expor conteúdos a respeito do
nosso cliente. Geralmente com várias abas, pois possuem uma quantidade de material
extensa a ser exposta.</p>
			</div>
		</div>
		<div class="explica2">
