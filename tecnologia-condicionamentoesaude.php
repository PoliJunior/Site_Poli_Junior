...
<html>
<head>
	<title>Sistema de Condicionamento e Saúde</title>
	...
	<div class="projeto">
		<div class="explica">
			<div class="nome-projeto">
				<h2>Projeto Sistema de Condicionamento e Saúde</h2>
			</div>
			<div class="textinho">
				<p class="texto-projeto">Serve para facilitar a comunicação entre o professor e seu respectivo aluno, passando
informações, como treinos e exercícios, necessárias com praticidade por meios
virtuais.<br><br>Também é dada a possibilidade para o próprio aluno colocar dados necessários, como
níveis de glicemia e pressão arterial, para que o professor tenha uma boa noção de
como deve agir.</p>
			</div>
		</div>
		<div class="explica2">
