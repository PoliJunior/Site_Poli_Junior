...
<html>
<head>
	<title>Civil Hidrossanitário</title>
...
<body>
	...
	<div class="projeto">
		<div class="explica">
			...
			<div class="textinho">
				<p class="texto-projeto">O projeto hidrossanitário consiste no dimensionamento adequado das tubulações de
					sistema de drenagem, tubulações de água fria e esgotamento sanitário, fazendo a
					ligação à rede pública de abastecimento e o retorno ao coletor público (ou se for o
					caso o retorno será feito a um sistema individual de tratamento).<br><br> Aliado às estratégias
					de descartes de fluidos garante sustentabilidade ao projeto e assim economia de
				recursos e autonomia.</p>
			</div>
		</div>
		<div class="explica2">
