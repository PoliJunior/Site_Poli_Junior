	...
	<div class="projeto">
		<div class="explica">
			<div class="nome-projeto">
				<h2>Projeto Retrofit</h2>
			</div>
			<div class="textinho">
				<p class="texto-projeto">É o procedimento de reformar e modernizar equipamentos industriais. A atualização
de máquinas industriais é a solução ideal para empresas manterem a produtividade
alta sem ter que arcar com investimentos pesados em bens de capital.<br><br>O retorno
financeiro acontece no curto e médio prazo e é um dos principais motivadores para a
adoção do retrofit de máquinas. Trocar partes móveis, recuperação e troca de peças
desgastadas, modernização dos sistemas eletrônicos e comandos da máquina.</p>
			</div>
		</div>
		<div class="explica2">
