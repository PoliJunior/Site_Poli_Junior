...
<body>
	...
	<div class="projeto">
		<div class="explica">
			...
			<div class="textinho">
				<p class="texto-projeto">O nosso plano de prevenção oferece desde uma detecção de fogo eficiente como um
detalhamento diferencial de instrumentos dedicados a combater eficientemente um
incêndio. Estudamos as melhores estratégias dedicadas ao perfil individual de cada
projeto de instalação, distribuindo assim rotas de fuga inteligentes e bem sinalizadas.</p>
			</div>
		</div>
		<div class="explica2">
