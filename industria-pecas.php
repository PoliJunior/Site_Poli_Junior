	...
	<div class="projeto">
		<div class="explica">
			<div class="nome-projeto">
				<h2>Projeto de Designe de Peças</h2>
			</div>
			<div class="textinho">
				<p class="texto-projeto">Desenvolvimento de peças pontuais para substituição daquelas com defeito ou
desgastadas em qualquer máquina que se necessite. Nosso serviço ocasiona um
grande conforto, baseado na produção sob a demanda da necessidade, bem como
grande economia por parte do cliente visto o valor de alguns maquinários em relação à
uma única peça.</p>
			</div>
		</div>
		<div class="explica2">
