	...
	<div class="projeto">
		<div class="explica">
			<div class="nome-projeto">
				<h2>Projeto Plataforma de E-Commerce</h2>
			</div>
			<div class="textinho">
				<p class="texto-projeto">Destinada para lojas ou empreendedores de pequeno a médio porte que buscam a
expansão do seu negócio. Uma loja virtual, além de claramente possibilitar vendas
online, traz um aspecto de profissionalismo e dinamiza processos que geralmente
demandam mais tempo, no dia a dia, como o próprio deslocamento até seu
estabelecimento.</p>
			</div>
		</div>
		<div class="explica2">
