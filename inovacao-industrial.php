...
<body>
	...
	<div class="projeto">
		<div class="explica">
			...
			<div class="textinho">
				<p class="texto-projeto">Automação industrial é a aplicação de técnicas ou softwares para um determinado
processo ou máquina industrial com a finalidade de aumentar a sua produção com a
menor quantidade de desperdício possível, melhorar a segurança e vida útil do
equipamento e reduzir o esforço ou interferência humana no mesmo.</p>
			</div>
		</div>
		<div class="explica2">
