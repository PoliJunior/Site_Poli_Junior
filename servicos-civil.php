        ...
        <div class="tudo">
            <div class="todo-titulo">
                <div class="titulo-topo">
                    <h2><strong>PROJETOS DE CONTRUÇÃO CIVIL</strong></h2>
                </div>
            </div>
            <div class="textinho">
                <p class="te">O nosso setor de construção civil está cada vez mais completo para conseguirmos
entregar desde projetos do zero até revitalizações, tudo no mesmo lugar com a melhor
qualidade para o nosso cliente ter a melhor experiência possível.</p>
            </div>
            <div class="engenharias">
                ...
                <div class="enge1">
                    ...
                    <div class="ger">
                    <div class="ti">
                       <a href="#"><h2 style="padding-bottom: 3.2%;">INSTALAÇÕES ELÉTRICAS</h2></a>
                    </div>
                    <div class="tex">
                        <p style="margin-top: 3%;">A Poli Junior Engenharia conta com uma área exclusiva em soluções de Engenharia Civil e elétrica com elaboração de Desenhos e Instalações Prediais usados na legalização e construção de imóveis.</p>
                    </div>
            ...
            <div class="listagem">
                ...
                <div class="enge1">
                    ...
                    <div class="ger">
                    <div class="ti">
                       <a href="#"><h2 style="padding-bottom: 3.2%;">ORÇAMENTO AVALIATIVO</h2></a>
                    </div>
                    <div class="tex">
                        <p style="margin-top: 3%;">A Poli Junior Engenharia conta com uma área exclusiva em soluções de Engenharia Civil e elétrica com elaboração de Desenhos e Instalações Prediais usados na legalização e construção de imóveis.</p>
                    </div>
            ...
            <div class="listagem">
                ...
                <div class="enge1">
                    ...
                    <div class="ger">
                    <div class="ti">
                       <a href="#"><h2 style="padding-bottom: 3.2%;">SUBESTEÇÃO</h2></a>
                    </div>
                    <div class="tex">
                        <p style="margin-top: 3%;">A Poli Junior Engenharia conta com uma área exclusiva em soluções de Engenharia Civil e elétrica com elaboração de Desenhos e Instalações Prediais usados na legalização e construção de imóveis.</p>
                    </div>
