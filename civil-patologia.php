	...
	<div class="projeto">
		<div class="explica">
			<div class="nome-projeto">
				<h2>Projeto de Patologia</h2>
			</div>
			<div class="textinho">
				<p class="texto-projeto">Alternativa para não desprender um enorme investimento em estruturas condenadas,
já que podem ser evitadas com esse tipo de projeto de manutenção preventiva.
Essencial para extinguir acidentes provocados por falhas humanas, que muitas vezes
são irreversíveis do ponto de vista de recuperação/reaproveitamento.</p>
			</div>
		</div>
		<div class="explica2">
