	...
	<div class="projeto">
		<div class="explica">
			<div class="nome-projeto">
				<h2>Projeto de IOT</h2>
			</div>
			<div class="textinho">
				<p class="texto-projeto">É o procedimento de obter uma ou mais informações locais ou isoladas, na nuvem. O
monitoramento de informações em tempo real de forma automatizada é a solução
perfeita para evitar gastos com contingente, além de fornecer a informação precisa,
não fornecendo espaço para erro humano.<br><br> Havendo um retorno financeiro à médio e
longo prazo de diminuição dos gastos. Implementação de uma Central para captura de
dados e com conexão à internet para envio dos dados.</p>
			</div>
		</div>
		<div class="explica2">
