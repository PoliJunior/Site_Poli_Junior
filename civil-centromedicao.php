...
<html>
<head>
	<title>Civil Cnetro de Medição</title>
	...
	<div class="projeto">
		<div class="explica">
			<div class="nome-projeto">
				<h2>Projeto de Centro de Medição</h2>
			</div>
			<div class="textinho">
				<p class="texto-projeto">É um projeto onde são dimensionados os cabos, tubulações, caixas e localização dos
equipamentos do centro de medição de acordo com a demanda de energia prevista
para o centro de medição.  O centro de medição elétrica de uma edificação pode ser
considerado o local mais importante de um sistema elétrico predial. Lá ocorre o
recebimento da energia elétrica da concessionária que é tarifada e distribuída por
ramais auxiliares para alimentação dos equipamentos.</p>
			</div>
		</div>
		<div class="explica2">
