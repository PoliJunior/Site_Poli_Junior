	...
	<div class="projeto">
		<div class="explica">
			<div class="nome-projeto">
				<h2>Projeto Sistema de Gestão Empresarial</h2>
			</div>
			<div class="textinho">
				<p class="texto-projeto">É um tipo de sistema usado para ter um maior controle e automatização de
informações, com interações com o usuário. Reduz a quantidade de documentos
separados, pois também os unifica. Com esse tipo projeto, você pode organizar dados
para uma melhor gestão, garantindo uma boa usabilidade.</p>
			</div>
		</div>
		<div class="explica2">
