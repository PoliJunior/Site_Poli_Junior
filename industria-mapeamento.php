	...
	<div class="projeto">
		<div class="explica">
			<div class="nome-projeto">
				<h2>Projeto Mapeamento de Processos</h2>
			</div>
			<div class="textinho">
				<p class="texto-projeto">Mapear todo o funcionamento da produção ou do serviço, com a intenção de
padronizar a atividade. Esse serviço garante uma maior facilidade na construção de
sistemas de medição, avaliando em tempo real a execução das tarefas, medições dos
resultados, custos, produtividade, entre outros, tornando mais fácil o seu
gerenciamento.</p>
			</div>
		</div>
		<div class="explica2">
