...
<html>
<head>
	<title>Automação de Máquinas de Lavar</title>
	...
	<div class="projeto">
		<div class="explica">
			<div class="nome-projeto">
				<h2>Projeto Automação de Máquinas de Lavar</h2>
			</div>
			<div class="textinho">
				<p class="texto-projeto">O serviço consiste na automatização de máquinas de lavar industriais ou residenciais,
possibilitando a programação da máquina de acordo com a necessidade do cliente. É
um serviço diferente do oferecido no mercado porque deixa o cliente livre para
escolher quais produtos utilizar nas lavagens de roupas, mantendo um padrão de
lavagem de excelência.</p>
			</div>
		</div>
		<div class="explica2">
