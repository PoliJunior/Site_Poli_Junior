	...
	<div class="projeto">
		<div class="explica">
			<div class="nome-projeto">
				<h2>Projeto Automação Residencial</h2>
			</div>
			<div class="textinho">
				<p class="texto-projeto">A automação residencial é o processo que deixa o espaço desejado cada vez mais
inteligente. A inteligência por trás da automação residencial permite que os ambientes
que fazem parte da sua rotina sejam melhores aproveitados, utilizando equipamentos
automatizados a favor de suas necessidades e hábitos, tendo total controle de acordo
com seu gosto.</p>
			</div>
		</div>
		<div class="explica2">
