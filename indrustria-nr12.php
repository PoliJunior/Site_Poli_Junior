	...
	<div class="projeto">
		<div class="explica">
			<div class="nome-projeto">
				<h2>Projeto de NR-12</h2>
			</div>
			<div class="textinho">
				<p class="texto-projeto">Análise de máquinas e equipamentos elaborando um relatório que engloba
informações dos problemas e soluções cabíveis, adequados de acordo com a Norma
Regulamentadora 12, NR12.<br><br>Não é somente se prezar de danos financeiros, como principalmente garantir a
segurança dos operadores e transeuntes.</p>
			</div>
		</div>
		<div class="explica2">
