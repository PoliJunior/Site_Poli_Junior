...
<html>
<head>
	<title>Civil Orçamento Avaliativo</title>
	...
	<div class="projeto">
		<div class="explica">
			<div class="nome-projeto">
				<h2>Projeto de Orçamento Avaliativo</h2>
			</div>
			<div class="textinho">
				<p class="texto-projeto">É o balanço avaliativo que estima de forma eficiente todos os preços envolvidos num
projeto executivo, monitorando assim gastos que possam ser evitados ou canalizados
para eventuais interesses do cliente.<br><br></p>
			</div>
		</div>
		<div class="explica2">
