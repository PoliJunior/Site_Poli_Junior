...
<body>
	...
	<div class="projeto">
		<div class="explica">
			...
			<div class="textinho">
				<p class="texto-projeto">Planejamento de controle de manutenção com intuito de garantir o bom funcionamento
de qualquer máquina industrial e segurança dos funcionários, o que ocasiona menor
risco aos trabalhadores ao mesmo tempo que garante uma menor probabilide de altos
custos com manutenção por problemas mecânicos do aparelho, que deviam ter sido
previstos no serviço de PCM.</p>
			</div>
		</div>
		<div class="explica2">
