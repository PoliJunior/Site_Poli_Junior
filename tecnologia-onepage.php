	...
	<div class="projeto">
		<div class="explica">
			<div class="nome-projeto">
				<h2>Projeto Site One Page</h2>
			</div>
			<div class="textinho">
				<p class="texto-projeto">Site com maior dinamicidade em questões de carregamento e exposição de conteúdo,
destinado para empresas com uma quantidade resumida de conteúdo para serem
expostos, em relação ao institucional.</p>
			</div>
		</div>
		<div class="explica2">
