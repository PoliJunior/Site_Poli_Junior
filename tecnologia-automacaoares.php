...
<html>
<head>
	<title>Automação Ares-Condicionados</title>
	...
	<div class="projeto">
		<div class="explica">
			<div class="nome-projeto">
				<h2>Projeto Automação Ares-Condicionados</h2>
			</div>
			<div class="textinho">
				<p class="texto-projeto">Sistema integrado a componentes eletrônicos que controlam e enviam informações
para diversos ares-condicionados em estabelecimentos ou instituições. Produto
integrado ao mercado de “IoT” (Internet das coisas).</p>
			</div>
		</div>
		<div class="explica2">
