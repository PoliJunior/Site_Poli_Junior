...
<div class="row-textos2">
    ...
    <div class="col-xs-6 col-md-4" system="float:right">.col-xs-6 .col-md-4</div>
</div>
<div class="porque">
    ...
    <section class="section--blue wow slideInLeft" data-wow-delay="0.1s">
        ...
        <div class="card">
            ...
            <div class="card-title1"><h3>Missão</h3></div>
    ...
    <section class="section--blue wow slideInLeft" data-wow-delay="0.5s">
        ...
        <div class="card">
            ...
            <div class="card-title1"><h3>Visão</h3></div>
            <div class="card-text"><p>O melhor custo-benefício em serviços de engenharia</p></div>
        </div>
    </section>
...
<div class="duvidas">
    <button class="collapsible" style="color: black;">Open Section 1</button>
    <div class="content">
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
            dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex
            ea commodo consequat.</p>
    </div>
    <button class="collapsible" style="color: black;">Open Section 2</button>
    <div class="content">
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
            dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex
            ea commodo consequat.</p>
