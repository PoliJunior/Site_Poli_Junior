...
<body>
	...
	<div class="projeto">
		<div class="explica">
			...
			<div class="textinho">
				<p class="texto-projeto">Planejamento de controle de produção a fim de redução de custos de matéria prima,
mão de obra e otimização das etapas de montagem dos produtos. Isso garante
redução dos custos operacionais, qualidade, produtividade e claro, bons resultados
conquistados.</p>
			</div>
		</div>
		<div class="explica2">
