<DOCTYPE html>
    ...
    <body>
        ...
        <div class="tudo">
            ...
            <div class="textinho">
                <p class="te">Nosso setor de indústria trabalha com empresas de todos os portes e priorizando o
resultado da mais alta qualidade, visto que o cotidiano da população é diretamente
ligado à eficácia dos meios de produção da nossa indústria.Os serviços oferecidos são:</p>
            </div>
