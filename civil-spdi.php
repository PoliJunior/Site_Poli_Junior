...
<body>
	...
	<div class="projeto">
		<div class="explica">
			...
			<div class="textinho">
				<p class="texto-projeto">Também conhecido como Sistema de Proteção contra Descargas Atmosféricas. Trata-
se do conjunto de dispositivos instalados no(s) ponto(s) mais alto(s) das edificações e
estruturas, conectados ao solo por meio de condutores metálicos, objetivando mitigar
as possibilidades destrutivas das descargas atmosféricas.</p>
			</div>
		</div>
		<div class="explica2">
