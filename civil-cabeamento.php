...
<html>
<head>
	<title>Civil Cabeamento Estruturado</title>
	...
	<div class="projeto">
		<div class="explica">
			<div class="nome-projeto">
				<h2>Projeto Cabeamento Estruturado</h2>
			</div>
			<div class="textinho">
				<p class="texto-projeto">O cabeamento estruturado é um método padronizado de cabear uma rede,
considerando as normas de segurança, as melhores práticas e o maior
aproveitamento de recursos dos equipamentos. com o objetivo de fornecer uma
infraestrutura de telecomunicações, como, por exemplo, transmitir dados através de
uma rede de computadores.</p>
			</div>
		</div>
		<div class="explica2">
