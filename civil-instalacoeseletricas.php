...
<html>
<head>
	<title>Civil Instalações Eletrica</title>
	...
	<div class="projeto">
		<div class="explica">
			<div class="nome-projeto">
				<h2>Projeto Instalações Eletricas</h2>
			</div>
			<div class="textinho">
				<p class="texto-projeto">Para que a energia elétrica possa ser utilizada em residências, prédios e indústrias
são necessários a montagem de um conjunto de condutores elétricos, proteções,
controles e acessórios especialmente instalados para tal finalidade e que são regidos
por normas técnicas específicas.</p>
			</div>
		</div>
		<div class="explica2">
